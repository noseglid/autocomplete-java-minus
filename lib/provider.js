...
class Provider {
  ...
  getSuggestions({ editor, bufferPosition, scopeDescriptor, prefix, activatedManually }) {
    ...
    if (dotPrefix) {
      ...
      mapper = this.mapMethodOrFieldToSuggestion;
  ...
  mapMethodOrFieldToSuggestion(entry) {
    return (entry._type === 'method') ?
      this.mapMethodEntryToSuggestion(entry) :
      this.mapFieldEntryToSuggestion(entry);
  }
